    ...
    <section className="form" >
                ...
                <form method="post" action="#!" className="form__wrapper" onSubmit={handleSubmit}>
                    <div className="form__data">
                      <div className="form__input-name">
                            <input name="name" onInput={(evt) => {
                                ...
                                className={`form__name form-hover-focus ${errorName ? "error" : ""}`}  type="text" value={name} placeholder="Имя и фамилия" />
                        ...
                        <div className="forms__input-rating">
                            <input  onInput={(evt) => {
                                ...
                                className={`form__rating form-hover-focus ${errorRating ? "error" : ""}`} name="rating" type="number" value={rating} placeholder="Оценка" />
                    ...
                    <textarea name="review" onInput={(evt) => {
                                ...
                                id="review" className="form__review form-hover-focus" placeholder="Текст отзыва" value={review}></textarea>
